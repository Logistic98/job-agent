...
const STORAGE_KEY = 'job-agent.resume-writer.markdown'
const FILE_NAME_KEY = 'job-agent.resume-writer.filename'
const FONT_SIZE_KEY = 'job-agent.resume-writer.font-size'
const LINE_HEIGHT_KEY = 'job-agent.resume-writer.line-height'
const PHOTO_KEY = 'job-agent.resume-writer.photo'
const PHOTO_SETTINGS_KEY = 'job-agent.resume-writer.photo-settings'
const PHOTO_LIBRARY_KEY = 'job-agent.resume-writer.photo-library'
const DEFAULT_PHOTO_URL = 'https://dummyimage.com/110x140/1890ff/ffffff&text=PHOTO'
const TAG_KEY = 'job-agent.resume-writer.tags'
const PROFILE_KEY = 'job-agent.resume-writer.profile'
