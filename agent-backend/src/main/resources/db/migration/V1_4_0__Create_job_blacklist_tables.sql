...
CREATE UNIQUE INDEX IF NOT EXISTS uk_job_agent_blacklist_item_name_type
  ON job_agent_blacklist_item (name, item_type);

INSERT INTO job_agent_blacklist_item(item_id, name, item_type, reason, source, enabled) VALUES
