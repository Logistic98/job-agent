package com.jobagent.backend.common.security;
...
public class ApiAuthenticationInterceptor implements HandlerInterceptor {
    ...
    public ApiAuthenticationInterceptor(UserLoginService userLoginService, JobAgentProperties properties, JsonCodec jsonCodec) {
