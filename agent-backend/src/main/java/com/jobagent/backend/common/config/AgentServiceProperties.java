...
public class AgentServiceProperties {
    ...
    public String getIntentUrl() { return intentUrl; }
    public void setIntentUrl(String intentUrl) { this.intentUrl = intentUrl; }
    public String getMemoryUrl() { return memoryUrl; }
    public void setMemoryUrl(String memoryUrl) { this.memoryUrl = memoryUrl; }
    public String getToolUrl() { return toolUrl; }
    public void setToolUrl(String toolUrl) { this.toolUrl = toolUrl; }
    public String getEvalUrl() { return evalUrl; }
    public void setEvalUrl(String evalUrl) { this.evalUrl = evalUrl; }
    ...
    public String resolvedRuntimeUrl() { return normalizeBaseUrl(runtimeUrl); }

    /** Normalized agent-sandbox base URL ("" when unconfigured). */
    public String resolvedSandboxUrl() { return normalizeBaseUrl(sandboxUrl); }
    ...
    public Duration getStreamConnectTimeout() { return streamConnectTimeout; }
    public void setStreamConnectTimeout(Duration streamConnectTimeout) { this.streamConnectTimeout = streamConnectTimeout; }
    public Duration getStreamReadTimeout() { return streamReadTimeout; }
    public void setStreamReadTimeout(Duration streamReadTimeout) { this.streamReadTimeout = streamReadTimeout; }
