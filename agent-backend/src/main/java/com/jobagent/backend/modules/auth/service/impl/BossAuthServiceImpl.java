package com.jobagent.backend.modules.auth.service.impl;

import com.jobagent.backend.modules.auth.event.BossAuthLostEvent;
...
public class BossAuthServiceImpl implements BossAuthService {
    ...
    @Scheduled(fixedDelayString = "${job-agent.boss-auth.validation-delay-ms:300000}", initialDelayString = "${job-agent.boss-auth.validation-initial-delay-ms:60000}")
