...
@Service
public class RuntimeToolClient {
    ...
    public RuntimeToolClient(RestTemplate restTemplate, AgentServiceProperties properties, ServiceResilience resilience) {
        this.restTemplate = restTemplate;
        this.properties = properties;
        this.resilience = resilience;
    }

    public Map<String, Object> invoke(String toolName, Map<String, Object> arguments, String sessionId, String workspaceDir) {
    ...
    private Map postForTool(String url, Map<String, Object> body, String toolName, boolean retryOnMissingTool) {
        try {
            ...
            if (retryOnMissingTool && response != null && response.contains("工具未找到")) {
                try {
                    restTemplate.postForObject(properties.getRuntimeUrl() + "/v1/runtime/tools/reload-builtins", Collections.emptyMap(), Map.class);
