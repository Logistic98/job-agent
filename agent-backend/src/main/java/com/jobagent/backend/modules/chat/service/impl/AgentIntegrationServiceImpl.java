...
import com.jobagent.backend.common.config.AgentServiceProperties;
import com.jobagent.backend.common.resilience.ServiceResilience;
...
public class AgentIntegrationServiceImpl implements AgentIntegrationService {
    ...
    public AgentIntegrationServiceImpl(RestTemplate restTemplate, AgentServiceProperties properties,
                                       JsonCodec jsonCodec, ServiceResilience resilience) {
    ...
    public List<Map<String, Object>> listTools() {
        ...
        return resilience.call("agent-tool", new java.util.function.Supplier<List<Map<String, Object>>>() {
            public List<Map<String, Object>> get() {
                Map response = restTemplate.getForObject(url, Map.class);
                Object data = response == null ? null : response.get("data");
                return data instanceof List ? (List<Map<String, Object>>) data : Collections.<Map<String, Object>>emptyList();
            }
        }, Collections.<Map<String, Object>>emptyList(), true);
    }

    public List<Map<String, Object>> searchMemory(final String query, final String scope) {
        final String url = properties.getMemoryUrl() + "/v1/memories/search?q=" + encode(query) + "&scope=" + encode(scope);
        return resilience.call("agent-memory", new java.util.function.Supplier<List<Map<String, Object>>>() {
            public List<Map<String, Object>> get() {
                Map response = restTemplate.getForObject(url, Map.class);
                Object data = response == null ? null : response.get("data");
                return data instanceof List ? (List<Map<String, Object>>) data : Collections.<Map<String, Object>>emptyList();
    ...
    public void writeMemory(final String scope, final String content) {
        resilience.call("agent-memory-write", new java.util.function.Supplier<Void>() {
            public Void get() {
                Map<String, String> request = new HashMap<String, String>();
                request.put("scope", scope);
                request.put("content", content);
                restTemplate.postForObject(properties.getMemoryUrl() + "/v1/memories", request, Map.class);
                return null;
            }
        }, null, false);
    }
    ...
    public Map<String, Object> evalTrace(final List<TraceStep> trace) {
        return resilience.call("agent-eval", new java.util.function.Supplier<Map<String, Object>>() {
            public Map<String, Object> get() {
                Map<String, Object> request = new HashMap<String, Object>();
                request.put("trace", trace);
                Map response = restTemplate.postForObject(properties.getEvalUrl() + "/v1/eval/trace", request, Map.class);
                Object data = response == null ? null : response.get("data");
                return data instanceof Map ? (Map<String, Object>) data : Collections.<String, Object>emptyMap();
            }
    ...
    public Map<String, Object> runRuntime(Map<String, Object> request) {
        ...
        Map<String, Object> result = postRuntime(baseUrl + "/v1/agent/runs", runtimeRequest);
        if (!result.isEmpty()) return result;
        return postRuntime(baseUrl + "/v1/runtime/runs", runtimeRequest);
    }

    public Map<String, Object> runRuntimeStream(Map<String, Object> request, Consumer<String> onToken) {
        return runRuntimeStream(request, onToken, null);
    }

    public Map<String, Object> runRuntimeStream(Map<String, Object> request, Consumer<String> onToken, Consumer<String> onReasoning) {
        String baseUrl = runtimeBaseUrl();
        if (baseUrl.isEmpty()) return Collections.emptyMap();
        ...
        try {
            ...
            String bodyJson = jsonCodec.toJson(request == null ? Collections.<String, Object>emptyMap() : request);
    ...
    private Map<String, Object> postRuntime(final String url, final Map<String, Object> request) {
        return resilience.call("agent-runtime", new java.util.function.Supplier<Map<String, Object>>() {
            public Map<String, Object> get() {
                Map response = restTemplate.postForObject(url, request, Map.class);
                Object data = response == null ? null : response.get("data");
                if (data instanceof Map) return (Map<String, Object>) data;
                return response == null ? Collections.<String, Object>emptyMap() : new HashMap<String, Object>(response);
            }
