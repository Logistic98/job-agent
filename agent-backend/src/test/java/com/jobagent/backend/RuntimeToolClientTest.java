...
class RuntimeToolClientTest {
    ...
    void invokeReturnsToolDataOnSuccess() {
        ...
        RuntimeToolClient client = new RuntimeToolClient(restTemplate, properties, new ServiceResilience(properties));

        Map<String, Object> data = new LinkedHashMap<String, Object>();
        data.put("status", "ok");
        Map<String, Object> envelope = new LinkedHashMap<String, Object>();
        envelope.put("data", data);
        when(restTemplate.postForObject(eq("http://runtime.local/v1/runtime/tools/boss_browser/invoke"), any(), eq(Map.class)))
                .thenReturn(envelope);

        Map<String, Object> result = client.invoke("boss_browser", Collections.<String, Object>emptyMap(), "sess-1", null);
