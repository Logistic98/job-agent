...
import com.jobagent.backend.modules.system.service.impl.SystemSettingsServiceImpl;
...
class SystemSettingsServiceSecurityTest {
    ...
    private SystemSettingsServiceImpl newService() {
        ...
        return new SystemSettingsServiceImpl(agentProperties, new JobAgentProperties(), mapper);
    }
