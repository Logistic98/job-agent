...
import com.jobagent.backend.modules.auth.client.BossBrowserClient;
import com.jobagent.backend.modules.auth.exception.BossAuthRequiredException;
import com.jobagent.backend.modules.auth.service.impl.BossCliServiceImpl;
...
class BossCliServiceImplTest {
    ...
    private BossCliServiceImpl newService(BossBrowserClient browserClient) {
        return new BossCliServiceImpl(browserClient, mock(ApplicationEventPublisher.class), new JobAgentProperties());
    }
