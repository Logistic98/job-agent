...
import com.jobagent.backend.modules.chat.service.impl.JobRuntimeServiceImpl;
...
class JobRuntimeServiceImplTest {
    ...
    void bossCandidatePoolTimeoutShouldAllowSlowFirstPageSearchByDefault() {
        ...
        BossCliService bossCliService = mock(BossCliService.class);
        SystemSettingsService settingsService = mock(SystemSettingsService.class);
        JobRuntimeServiceImpl service = new JobRuntimeServiceImpl(runtimeToolClient, new JobAgentProperties(), bossAuthService, new JsonCodec(), bossCliService, settingsService);
